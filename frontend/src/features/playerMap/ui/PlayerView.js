...
import RoomLayer from '../../masterMap/ui/RoomLayer';
import ShapeLayer from '../../masterMap/ui/ShapeLayer';
import ItemInstanceLayer from '../../../entities/shape/ItemInstanceLayer'; // 👈 подключи слой предметов
