...
class MapPoint(models.Model):
    ...
    target_room = models.ForeignKey(Room, on_delete=models.SET_NULL, null=True, blank=True, related_name='target_points', verbose_name="Целевая комната (для порталов)")
