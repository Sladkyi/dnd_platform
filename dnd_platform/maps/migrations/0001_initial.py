# Generated by Django 5.1.5 on 2025-06-21 13:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attacks', to='maps.inventoryitem')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charStory', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('attacks', models.ManyToManyField(blank=True, related_name='shapes', to='maps.attack')),
        ...
        migrations.AddField(
            model_name='attack',
            name='owner',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='custom_attacks', to='maps.shape'),
        ),
        migrations.CreateModel(
            name='Spell',
            fields=[
        ...
        migrations.AddField(
            model_name='attack',
            name='source_spell',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attacks', to='maps.spell'),
        ),
        migrations.CreateModel(
